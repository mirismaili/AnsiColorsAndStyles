 ...
 *
 * Full reference: https://en.wikipedia.org/wiki/ANSI_escape_code
 */
...
export const _K       = BG_BLACK;
export const _BK      = BG_BLACK;
export const _BLK     = BG_BLACK;
export const _BLACK   = BG_BLACK;

export const _R       = BG_RED;
export const _RD      = BG_RED;
export const _RED     = BG_RED;

export const _G       = BG_GREEN;
export const _GR      = BG_GREEN;
export const _GRN     = BG_GREEN;
export const _GREEN   = BG_GREEN;

export const _Y       = BG_YELLOW;
export const _YL      = BG_YELLOW;
export const _YLW     = BG_YELLOW;
export const _YELLOW  = BG_YELLOW;

export const _E       = BG_BLUE;
export const _BL      = BG_BLUE;
export const _BLU     = BG_BLUE;
export const _BLUE    = BG_BLUE;

export const _M       = BG_MAGENTA;
export const _MG      = BG_MAGENTA;
export const _MGN     = BG_MAGENTA;
export const _MAGENTA = BG_MAGENTA;

export const _C       = BG_CYAN;
export const _CN      = BG_CYAN;
export const _CYN     = BG_CYAN;
export const _CYAN    = BG_CYAN;

export const _W       = BG_WHITE;
export const _WT      = BG_WHITE;
export const _WHT     = BG_WHITE;
export const _WHITE   = BG_WHITE;
